...
- Essa função, fica no arquivo retornaMedicos.js, é responsável por consultar o **banco de dados MySQL** através do módulo *conexao.js.*

### 2.3 Consulta no Banco de dados
- O arquivo **conexao.js** estabelece a conexão com o banco de dados e executa a consulta SQL: *SELECT * FROM medicos*;
...
### 2.6 Fim
- O processo termina após o envio da resposta (sucesso ou erro) ao cliente.
